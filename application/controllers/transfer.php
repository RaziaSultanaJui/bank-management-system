    ...
    if (isset($_POST['transfer']))
    {
      ...
      if ($array ->num_rows > 0) 
      {
         while ($row = $array->fetch_assoc()) 
         {
            ...
            {
              echo "<div class='list-group-item list-group-item-action bg-gradient-info'>Transfer have been made for  BDT.$row[debit] from your account at $row[date] in  account no.$row[other]</div>";
            }
