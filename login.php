...
<head>
    ...
    define('bankname', 'CSE470 Bank Ltd');
	session_start();
...
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	<input type="email" value="asfia@mail.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="asfia" class="form-control" required placeholder="Enter Password">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
        <form method="POST">
       	<input type="email" value="cashier@mail.com" name="email" class="form-control" required placeholder="Enter Email">
